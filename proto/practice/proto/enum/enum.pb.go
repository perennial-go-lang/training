...
func (DayOfTheWeek) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_enum_8ed3a4b4d5c17d82, []int{0}
}
...
func init() { proto.RegisterFile("enum/enum.proto", fileDescriptor_enum_8ed3a4b4d5c17d82) }

var fileDescriptor_enum_8ed3a4b4d5c17d82 = []byte{
